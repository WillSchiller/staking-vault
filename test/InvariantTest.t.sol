...
contract InvariantTest is Test {
    ...
    function invariant_TotalDepositsMatchVault() public {
        ...
        assertApproxEqAbs(vault.totalAssets(), netDeposited, tolerance, "Vault total assets mismatch");
    }
    ...
    function invariant_RewardsLogic() public {
        ...
        assertApproxEqAbs(totalRewardsAdded, totalUnclaimedRewards + totalRewardsClaimed, 1e9, "Rewards added mismatch");
    }
